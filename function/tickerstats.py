...
def lambda_handler(event, context):
    ...
    for x in emlist:
        ...
        logger.info("dc:%f %s h:%f l:%f rsi:%f macd:%f macds:%f macdh:%f" %(lookup.dejitter_close(), a, lookup.high, lookup.low, i.rsi(), i.macd(), i.macds(), i.macdh()))
